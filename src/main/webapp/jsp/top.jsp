...
<div style="float: left"><a href="${pageContext.request.contextPath}/jsp/lang?command=EN">EN</a>&nbsp;</div>
<div style="float: left"><a href="${pageContext.request.contextPath}/jsp/lang?command=RU">РУС</a></div>
